...
public enum ChainType {
	...
	private int outstandingSharesCount = INIT_SHARE_COUNT;
	...
	public int getOutstandingSharesCount() {
		return outstandingSharesCount;
	}

	public void buyShares(int count) {
		assert(count >= outstandingSharesCount);
		outstandingSharesCount -= count;
	}

	public void sellShares(int count) {
		outstandingSharesCount += count;

		assert(outstandingSharesCount <= INIT_SHARE_COUNT);
	}
}
